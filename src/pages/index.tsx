  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience the thrill of cryptocurrency gaming with DogePot. Win big in our on-chain raffle, powered by the robust Binance Smart Chain."
        />
      </Head>
      ...
      <Stack minH={'100vh'} direction={{ base: 'column', md: 'row' }}>
        <Flex p={8} flex={1} align={'center'} justify={'center'}>
          <Stack position="relative" spacing={6} w={'full'} maxW={'lg'}>
            ...
            <Text fontSize={{ base: 'md', lg: 'lg' }} color={'gray.500'}>
              {`Experience the thrill of cryptocurrency gaming with DogePot. Win big in our on-chain raffle, powered by the robust Binance Smart Chain.`}
            </Text>
        ...
        <Flex position="relative" flex={1}>
          <Image
            src={
              'https://images.unsplash.com/photo-1639777410869-ab58aa2c7b84?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxjcnlwdG9jdXJyZW5jeSUyQ3JhZmZsZXxlbnwwfHx8fDE2ODgyNzI0MDZ8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt={'Login Image'}
            objectFit={'cover'}
          />
