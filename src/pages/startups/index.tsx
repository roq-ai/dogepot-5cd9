...
function StartupListPage() {
  ...
  const { data, error, isLoading, mutate } = useSWR<StartupInterface[]>(
    ...
    () =>
      getStartups({
        relations: ['user', 'invitation.count', 'participation.count', 'raffle.count'],
      }),
  );
            ...
            <Table variant="simple">
              <Thead>
                <Tr>
                  ...
                  {hasAccess('raffle', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && <Th>raffle</Th>}
                  <Th>Actions</Th>
                </Tr>
              </Thead>
              <Tbody>
